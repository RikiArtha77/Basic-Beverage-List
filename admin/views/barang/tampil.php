    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <td>Id Minuman</td><td>Nama Minuman</td><th>Jenis Minuman</th><th>Ukuran</th><td>Aksi</td>
            </tr>
        </thead>
        <tbody>
            <?php if($minuman != NULL){ 
                ...
                foreach($minuman as $row){?>
                    <tr>
                        <td><?=$no;?></td><td><?=$row['id_minuman']?></td><td><?=$row['nama_minuman'];?></td><td><?=$row['jenis_minuman']?></td><td><?=$row['ukuran']?></td>            
                        <td>
